...
public class JPushClientUtil {
    private final static String appKey = "675d8835e28b7833f2275525";
    private final static String masterSecret = "cbce01a2a7aed79a5cad22f8";
     ...
     * @return
     */
    public static int sendToAllAndroid(String notification_title, String notification_alert, String msg_title, String msg_content, String extrasparam, String alias) {
        return sendToAllAndroid(notification_title, notification_alert, msg_title, msg_content, extrasparam, alias, 12);
    }
    /**
     * 发送给所有安卓用户
     *
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToAllAndroid(String notification_title, String notification_alert, String msg_title, String msg_content, String extrasparam, String alias, int time_to_target) {
        int result = 0;
        try {
            PushPayload pushPayload = JPushClientUtil.buildPushObject_android_all_alertWithTitle(notification_title, notification_alert, msg_title, msg_content, extrasparam, alias, time_to_target);
     ...
     * @return
     */
    private static PushPayload buildPushObject_android_all_alertWithTitle(String notification_title, String notification_alert, String msg_title, String msg_content, String extrasparam, String alias, int time_to_live) {
        ...
        return PushPayload.newBuilder()
                ...
                //jpush的通知，android的由jpush直接下发，iOS的由apns服务器下发，Winphone的由mpns下发
                .setNotification(Notification.newBuilder()
                        //指定当前推送的android通知，Title为标题，Alert为内容
                        .addPlatformNotification(AndroidNotification.newBuilder()
                                //指定当前推送的内容
                ...
                .setOptions(Options.newBuilder()
                        ...
                        .setSendno(10)
                        //此字段的值是用来指定本推送的离线保存时长，如果不传此字段则默认保存一天，最多指定保留十天，单位为秒
                        .setTimeToLive(time_to_live * 60 * 60)
                        .build())
                .build();
    }
    /**
    ...
    /*public static void login() {
        try {
            String url = "http://wen.qukaa.com/api/account/login_process/";
            URL httpUrl = null;
            httpUrl = new URL(url);
            ...
            String content = "user_name=" + "18844093508" + "&password=" + "123456789";
    ...
    /*public static void loop() {
        String url = "http://wen.qukaa.com/notifications/ajax/notice/?flag=0&type=200&page=1";
        URL httpUrl = null;
        try {
            httpUrl = new URL(url);
            HttpURLConnection conn = (HttpURLConnection) httpUrl.openConnection();
            ...
            int a = jsonObj1.getJSONObject("rsm").getInt("total_rows");
            if (a != 0) {
                if (com.example.push.JPushClientUtil.sendToAllAndroid("Hello AcademicHeadlines!", "学术头条", "", "", "value") == 1) {
